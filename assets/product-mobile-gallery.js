class MobileGallery extends HTMLElement {
  ...
  // Limit image size to 750px for zooming
  ...
  zoomImg.onload = () => {
    ...
    if (allowZoom) {
      ...
      hammer.on('pinchmove', (e) => {
        // Calculate max scale to keep image within 750px x 750px
        const maxScale = Math.min(
          750 / zoomImg.naturalWidth,
          750 / zoomImg.naturalHeight,
          3 // Original max scale
        );
      ...
      hammer.on('doubletap', () => {
        ...
        // Adjust double-tap zoom levels to respect 750px limit
        const maxScale = Math.min(
          750 / zoomImg.naturalWidth,
          750 / zoomImg.naturalHeight,
          3
