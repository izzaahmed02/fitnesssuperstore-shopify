function createAssemblySelect(){
    ...
    r.innerHTML='<h3 id="double-assembly-header" class="avp-heading ap-options__heading ">Assembly &amp; Room of Choice Installation Needed?</h3>';

    // Wrapper div holds select + arrow SVG
    let wrapper=document.createElement("div");
    wrapper.classList.add("assembly-select-wrapper");

    let l=document.createElement("select");
    l.setAttribute("id","double-assembly-input");
    l.setAttribute("aria-labelledby","double-assembly-header");

    // Arrow injected as real DOM element — immune to theme CSS overrides
    let arrow=document.createElement("span");
    arrow.classList.add("assembly-select-arrow");
    arrow.innerHTML=`<svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="https://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M0.46967 0.46967C0.762563 0.176777 1.23744 0.176777 1.53033 0.46967L7 5.93934L12.4697 0.46967C12.7626 0.176777 13.2374 0.176777 13.5303 0.46967C13.8232 0.762563 13.8232 1.23744 13.5303 1.53033L7.53033 7.53033C7.23744 7.82322 6.76256 7.82322 6.46967 7.53033L0.46967 1.53033C0.176777 1.23744 0.176777 0.762563 0.46967 0.46967Z" fill="black"/></svg>`;
    ...
    if(l){
        t.forEach(e=>{
            ...
            e.addEventListener("change",e=>{
                l.querySelectorAll(`option[name="${e.target.value}"]`)[0].selected=true;
            });
        });
        ...
        document.querySelector(".installation-group").prepend(wrapper);
